...
client.channels.find('id', '532954636672434190').setName(`Time - ${hours} : ${ReBeeL} : ${ReBeeeL} ${suffix}`) 
client.channels.find('id', '532954636672434190').setName(`Date : ${Codes} - ${CodeS} - ${CoDeS}`)
}, 1000);
});
